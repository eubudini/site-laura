...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const INSTAGRAM_POSTS = [
    ...
    { shortcode: 'DFZ0Mz2J66E', profile: '@marinaciconet', initials: 'MC', label: 'Marina Ciconet' },
    { shortcode: 'DGAzDwKpgsF', profile: '@marinaciconet', initials: 'MC', label: 'Marina Ciconet' },
    { shortcode: 'DE-1wdgJRZn', profile: '@marinaciconet', initials: 'MC', label: 'Marina Ciconet' },
